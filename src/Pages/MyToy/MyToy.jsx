...
const MyToy = () => {
  ...
  useEffect(() => {
    fetch(
      `https://b7a11-toy-marketplace-server-side-eftekhar-alam2.vercel.app/toys/email/${user?.email}`,
      {
        method: "GET",
      }
    )
  ...
  const handleDelete = (id) => {
    ...
    if (proceed) {
      fetch(
        `https://b7a11-toy-marketplace-server-side-eftekhar-alam2.vercel.app/toys/${id}`,
        {
          method: "DELETE",
        }
      )
